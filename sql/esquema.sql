-- Ambiente didático: esquema e políticas das Seções 8.2 e 8.3.
-- Execute em um projeto novo. Não migra tabelas de versões anteriores.
...
-- Permissão ampla intencional para o laboratório, conforme o enunciado.
